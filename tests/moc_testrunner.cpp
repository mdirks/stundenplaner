...
static const char qt_meta_stringdata_TestView[] = {
    "TestView\0\0runSelectedTests()\0"
};
...
void TestView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        TestView *_t = static_cast<TestView *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData TestView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TestView::staticMetaObject = {
    { &QTableWidget::staticMetaObject, qt_meta_stringdata_TestView,
      qt_meta_data_TestView, &staticMetaObjectExtraData }
};
